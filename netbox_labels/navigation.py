    ...
    groups=(
        (_('QR Коди'), (
            PluginMenuItem(
                ...
                permissions=['netbox_labels.view_qrtemplate'],
                buttons=(
                    PluginMenuButton(
        ...
        (_('Configuration'), (
            PluginMenuItem(
                link='plugins:netbox_labels:settings',
                link_text=_('Settings'),
                permissions=['netbox_labels.change_qrtemplate'],
            ),
            PluginMenuItem(
                link='plugins:netbox_labels:qrsizepreset_list',
                link_text=_('Size Presets'),
                permissions=['netbox_labels.view_qrsizepreset'],
                buttons=(
                    PluginMenuButton(
