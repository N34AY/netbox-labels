/**
 * Vendored unmodified (all-barcode-formats minified bundle) from
 * https://github.com/lindell/JsBarcode (MIT license). Exposes a global
 * `JsBarcode(element, value, options)` — see barcode-render.js for usage.
 */
