...
class QRTemplateEditView(generic.ObjectEditView):
    ...
    template_name = 'netbox_qr/qrtemplate_edit.html'
...
class QRTemplateDesignView(LoginRequiredMixin, PermissionRequiredMixin, View):
    ...
    permission_required = 'netbox_qr.change_qrtemplate'
    ...
    def get(self, request, pk):
        ...
        return render(request, 'netbox_qr/qrtemplate_design.html', {
            'object': qr_template,
            'layout': layout,
    ...
    def post(self, request, pk):
        ...
        try:
            ...
            return redirect('plugins:netbox_qr:qrtemplate_design', pk=qr_template.pk)
        ...
        return redirect('plugins:netbox_qr:qrtemplate', pk=qr_template.pk)
...
class QRTemplatePreviewView(LoginRequiredMixin, PermissionRequiredMixin, View):
    ...
    def post(self, request, pk):
        ...
        context['netbox_qr_meta'] = {
            'value': context['qr_value'],
            'objectType': None,
            'objectTypeId': None,
            'objectId': None,
        }
        return render(request, 'netbox_qr/render.html', context)
...
class QRBulkPrintView(LoginRequiredMixin, View):
    ...
    def post(self, request):
        ...
        return render(request, 'netbox_qr/qrtemplate_bulk_print.html', {
...
class QRBulkPrintSheetView(LoginRequiredMixin, View):
    ...
    def post(self, request):
        ...
        return render(request, 'netbox_qr/qrtemplate_bulk_print_sheet.html', {
...
class QRSettingsView(LoginRequiredMixin, PermissionRequiredMixin, View):
    ...
    def get(self, request):
        ...
        return render(request, 'netbox_qr/settings.html', {'form': form})
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            return redirect('plugins:netbox_qr:settings')
        return render(request, 'netbox_qr/settings.html', {'form': form})
