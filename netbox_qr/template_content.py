...
def _make_panel_extension(model_label):
    class QRObjectPanel(PluginTemplateExtension):
        ...
        def right_page(self):
            ...
            if not qr_templates:
                return ''
            return self.render('netbox_qr/inc/object_qr_panel.html', extra_context={
    ...
    class QRListButton(PluginTemplateExtension):
        ...
        def list_buttons(self):
            ...
            if not has_templates:
                return ''
            return self.render('netbox_qr/inc/bulk_print_button.html', extra_context={
                'content_type_id': content_type.pk,
                'bulk_print_url': reverse('plugins:netbox_qr:qrbulk_print'),
            })
