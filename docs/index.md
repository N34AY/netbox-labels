...
A **Label Template** defines an HTML/CSS/JS label for one or more NetBox object types — written by
...
- [Label Template](qrtemplate.md) — the label itself: what it looks like, what data it encodes,
  and which object types it applies to.
- [Label Size Preset](qrsizepreset.md) — named label sizes offered as quick picks in the visual
  designer.
